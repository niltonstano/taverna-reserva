...
// ✅ Interface reforçada para evitar erros de propriedade
interface Vinho {
  _id: string;
  name: string;
  description?: string;
...
export function ProductDetail() {
  ...
  useEffect(() => {
    ...
    async function loadProduct() {
      try {
        ...
        // Tenta pegar os dados de diferentes níveis da resposta da API
  ...
  // ✅ FUNÇÃO DE CLIQUE INTEGRADA: ADICIONA E DEPOIS REDIRECIONA
  const handleButtonClick = () => {
    if (!vinho) return;

    if (!added) {
      // Primeiro clique: Adiciona ao carrinho no contexto global
      addToCart({
        ...vinho,
        id: vinho._id,
        quantity: 1,
      ...
      setAdded(true);
      // Mantemos o "added" como true para que o botão mude permanentemente nesta visita
    } else {
      // Segundo clique: Como já foi adicionado, leva para o carrinho
      navigate('/cart');
    }
  };
    ...
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center text-center px-6">
        ...
        <button
          ...
          className="text-[#c2410c] font-cinzel uppercase tracking-[0.3em] text-[10px] border-b border-[#c2410c] pb-2"
        >
          Voltar para a Adega
        </button>
      </div>
  ...
  // ✅ Lógica de Fallback de Imagem (Proteção total)
    ...
    <div className="min-h-screen bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-32 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          {/* LADO ESQUERDO: IMAGEM COM PROTEÇÃO */}
          <div className="relative">
            <div className="bg-zinc-900/30 border border-white/5 rounded-[80px] aspect-[4/5] flex items-center justify-center shadow-2xl relative backdrop-blur-xl">
          ...
          <div className="flex flex-col">
            <header className="space-y-8">
              <div className="px-5 py-2 w-fit bg-[#c2410c]/10 border border-[#c2410c]/20 rounded-full flex items-center gap-3">
              ...
              <p className="text-zinc-400 font-serif leading-relaxed text-xl italic max-w-xl border-l-2 border-[#c2410c]/30 pl-8">
                {vinho.description || 'Uma experiência sensorial única reservada para os melhores momentos.'}
              </p>
            </header>

            {/* ATRIBUTOS */}
            <div className="grid grid-cols-3 gap-8 py-12 my-12 border-y border-white/5">
              <div className="text-center">
                <Droplets size={24} className="text-[#c2410c]/40 mx-auto mb-4" />
              ...
              <div className="text-center border-x border-white/5">
                <Thermometer size={24} className="text-[#c2410c]/40 mx-auto mb-4" />
              ...
              <div className="text-center">
                <GlassWater size={24} className="text-[#c2410c]/40 mx-auto mb-4" />
            ...
            {/* COMPRA: BOTÃO LINKADO AO CARRINHO */}
            <div className="flex flex-col sm:flex-row items-end sm:items-center justify-between gap-12 pt-4">
              <div className="space-y-2">
                <p className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.5em]">Valor de Investimento</p>
